...
export default (commander: Commander): void => {
    ...
    createFoodPoll(
        ['fondue', 'foodpoll', 'fp'],
        'Luo pollin ruokapaikan valitsemiselle',
        'Fondue?',
        ['Reaktori', 'Newton', 'Hertsi', 'Såås'],
    );
    ...
    createFoodPoll(
        ['lounaskeskusta', 'bk', 'baakeskusta'],
        'Pollaa keskustan lounasravintolat',
        'Bääbää nams?',
        ['Burger', 'Pizza', 'Sushi', 'Kiinalainen', 'Ramen', 'Salaatti', 'Siivet', 'Perussuomalainen'],
    );
