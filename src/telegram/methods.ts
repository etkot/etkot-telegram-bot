...
export abstract class TelegramMethods {
    ...
    getUpdates(optional?: {
        ...
        return this.sendMethod(
            new TG.getUpdates(optional?.offset, optional?.limit, optional?.timeout, optional?.allowed_updates)
        ) as Promise<Array<TG.Update>>
    }
    ...
    forwardMessage(
        ...
        return this.sendMethod(
            new TG.forwardMessage(chat_id, from_chat_id, message_id, optional?.disable_notification)
        ) as Promise<TG.Message>
    }
    ...
    sendLocation(
        ...
        return this.sendMethod(
            new TG.sendLocation(
                ...
                latitude,
                longitude,
                optional?.horizontal_accuracy,
                optional?.live_period,
                optional?.heading,
                optional?.proximity_alert_radius,
                optional?.disable_notification,
                optional?.reply_to_message_id,
                optional?.allow_sending_without_reply,
                optional?.reply_markup
    ...
    editMessageLiveLocation(
        ...
        return this.sendMethod(
            new TG.editMessageLiveLocation(
                latitude,
                longitude,
                optional?.chat_id,
                optional?.message_id,
    ...
    stopMessageLiveLocation(optional?: {
        ...
        return this.sendMethod(
            new TG.stopMessageLiveLocation(
                optional?.chat_id,
                optional?.message_id,
                optional?.inline_message_id,
                optional?.reply_markup
    ...
    sendVenue(
        ...
        return this.sendMethod(
            new TG.sendVenue(
                ...
                optional?.foursquare_type,
                optional?.google_place_id,
                optional?.google_place_type,
                optional?.disable_notification,
                optional?.reply_to_message_id,
                optional?.allow_sending_without_reply,
                optional?.reply_markup
    ...
    getUserProfilePhotos(
        ...
        return this.sendMethod(
            new TG.getUserProfilePhotos(user_id, optional?.offset, optional?.limit)
        ) as Promise<TG.UserProfilePhotos>
    }
    ...
    restrictChatMember(
        ...
        return this.sendMethod(
            new TG.restrictChatMember(chat_id, user_id, permissions, optional?.until_date)
        ) as Promise<true>
    }
    ...
    promoteChatMember(
        ...
        return this.sendMethod(
            new TG.promoteChatMember(
                chat_id,
                user_id,
                optional?.is_anonymous,
                optional?.can_change_info,
                optional?.can_post_messages,
                optional?.can_edit_messages,
                optional?.can_delete_messages,
                optional?.can_invite_users,
                optional?.can_restrict_members,
                optional?.can_pin_messages,
                optional?.can_promote_members
            )
        ) as Promise<true>
    }
    ...
    pinChatMessage(
        ...
        return this.sendMethod(
            new TG.pinChatMessage(chat_id, message_id, optional?.disable_notification)
        ) as Promise<true>
    }
    ...
    answerShippingQuery(
        ...
        return this.sendMethod(
            new TG.answerShippingQuery(shipping_query_id, ok, optional?.shipping_options, optional?.error_message)
        ) as Promise<true>
    }
    ...
    answerPreCheckoutQuery(
        ...
        return this.sendMethod(
            new TG.answerPreCheckoutQuery(pre_checkout_query_id, ok, optional?.error_message)
        ) as Promise<true>
    }
    ...
    getGameHighScores(
        ...
        return this.sendMethod(
            new TG.getGameHighScores(user_id, optional?.chat_id, optional?.message_id, optional?.inline_message_id)
        ) as Promise<Array<TG.GameHighScore>>
    }
}
