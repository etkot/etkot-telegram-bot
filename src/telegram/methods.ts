...
export abstract class TelegramMethods {
    ...
    setWebhook(url: string, optional?: { certificate?: TG.InputFile, ip_address?: string, max_connections?: number, allowed_updates?: Array<string>, drop_pending_updates?: boolean }): Promise<true> {
        return this.sendMethod(new TG.setWebhook(url, optional?.certificate, optional?.ip_address, optional?.max_connections, optional?.allowed_updates, optional?.drop_pending_updates)) as Promise<true>
    }

    /** Use this method to remove webhook integration if you decide to switch back to [getUpdates](https://core.telegram.org/bots/api#getupdates). Returns True on success. */
    deleteWebhook(optional?: { drop_pending_updates?: boolean }): Promise<true> {
        return this.sendMethod(new TG.deleteWebhook(optional?.drop_pending_updates)) as Promise<true>
    }
    ...
    logOut(): Promise<true> {
        return this.sendMethod(new TG.logOut()) as Promise<true>
    }

    /** Use this method to close the bot instance before moving it from one local server to another. You need to delete the webhook before calling this method to ensure that the bot isn&#39;t launched again after server restart. The method will return error 429 in the first 10 minutes after the bot is launched. Returns True on success. Requires no parameters. */
    close(): Promise<true> {
        return this.sendMethod(new TG.close()) as Promise<true>
    }
    ...
    editMessageLiveLocation(latitude: number, longitude: number, optional?: { chat_id?: number|string, message_id?: number, inline_message_id?: string, horizontal_accuracy?: number, heading?: number, proximity_alert_radius?: number, reply_markup?: TG.InlineKeyboardMarkup }): Promise<TG.Message | true> {
        return this.sendMethod(new TG.editMessageLiveLocation(latitude, longitude, optional?.chat_id, optional?.message_id, optional?.inline_message_id, optional?.horizontal_accuracy, optional?.heading, optional?.proximity_alert_radius, optional?.reply_markup)) as Promise<TG.Message | true>
    }

    /** Use this method to stop updating a live location message before  is returned, otherwise True is returned. */
    stopMessageLiveLocation(optional?: { chat_id?: number|string, message_id?: number, inline_message_id?: string, reply_markup?: TG.InlineKeyboardMarkup }): Promise<true> {
        return this.sendMethod(new TG.stopMessageLiveLocation(optional?.chat_id, optional?.message_id, optional?.inline_message_id, optional?.reply_markup)) as Promise<true>
    }
    ...
    sendChatAction(chat_id: number|string, action: string): Promise<true> {
        return this.sendMethod(new TG.sendChatAction(chat_id, action)) as Promise<true>
    }
    ...
    kickChatMember(chat_id: number|string, user_id: number, optional?: { until_date?: number }): Promise<true> {
        return this.sendMethod(new TG.kickChatMember(chat_id, user_id, optional?.until_date)) as Promise<true>
    }

    /** Use this method to unban a previously kicked user in a supergroup or channel. The user will not return to the group or channel automatically, but will be able to join via link, etc. The bot must be an administrator for this to work. By default, this method guarantees that after the call the user is not a member of the chat, but will be able to join it. So if the user is a member of the chat they will also be removed from the chat. If you don&#39;t want this, use the parameter only_if_banned. Returns True on success. */
    unbanChatMember(chat_id: number|string, user_id: number, optional?: { only_if_banned?: boolean }): Promise<true> {
        return this.sendMethod(new TG.unbanChatMember(chat_id, user_id, optional?.only_if_banned)) as Promise<true>
    }

    /** Use this method to restrict a user in a supergroup. The bot must be an administrator in the supergroup for this to work and must have the appropriate admin rights. Pass True for all permissions to lift restrictions from a user. Returns True on success. */
    restrictChatMember(chat_id: number|string, user_id: number, permissions: TG.ChatPermissions, optional?: { until_date?: number }): Promise<true> {
        return this.sendMethod(new TG.restrictChatMember(chat_id, user_id, permissions, optional?.until_date)) as Promise<true>
    }

    /** Use this method to promote or demote a user in a supergroup or a channel. The bot must be an administrator in the chat for this to work and must have the appropriate admin rights. Pass False for all boolean parameters to demote a user. Returns True on success. */
    promoteChatMember(chat_id: number|string, user_id: number, optional?: { is_anonymous?: boolean, can_change_info?: boolean, can_post_messages?: boolean, can_edit_messages?: boolean, can_delete_messages?: boolean, can_invite_users?: boolean, can_restrict_members?: boolean, can_pin_messages?: boolean, can_promote_members?: boolean }): Promise<true> {
        return this.sendMethod(new TG.promoteChatMember(chat_id, user_id, optional?.is_anonymous, optional?.can_change_info, optional?.can_post_messages, optional?.can_edit_messages, optional?.can_delete_messages, optional?.can_invite_users, optional?.can_restrict_members, optional?.can_pin_messages, optional?.can_promote_members)) as Promise<true>
    }

    /** Use this method to set a custom title for an administrator in a supergroup promoted by the bot. Returns True on success. */
    setChatAdministratorCustomTitle(chat_id: number|string, user_id: number, custom_title: string): Promise<true> {
        return this.sendMethod(new TG.setChatAdministratorCustomTitle(chat_id, user_id, custom_title)) as Promise<true>
    }

    /** Use this method to set default chat permissions for all members. The bot must be an administrator in the group or a supergroup for this to work and must have the can_restrict_members admin rights. Returns True on success. */
    setChatPermissions(chat_id: number|string, permissions: TG.ChatPermissions): Promise<true> {
        return this.sendMethod(new TG.setChatPermissions(chat_id, permissions)) as Promise<true>
    }
    ...
    setChatPhoto(chat_id: number|string, photo: TG.InputFile): Promise<true> {
        return this.sendMethod(new TG.setChatPhoto(chat_id, photo)) as Promise<true>
    }

    /** Use this method to delete a chat photo. Photos can&#39;t be changed for private chats. The bot must be an administrator in the chat for this to work and must have the appropriate admin rights. Returns True on success. */
    deleteChatPhoto(chat_id: number|string): Promise<true> {
        return this.sendMethod(new TG.deleteChatPhoto(chat_id)) as Promise<true>
    }

    /** Use this method to change the title of a chat. Titles can&#39;t be changed for private chats. The bot must be an administrator in the chat for this to work and must have the appropriate admin rights. Returns True on success. */
    setChatTitle(chat_id: number|string, title: string): Promise<true> {
        return this.sendMethod(new TG.setChatTitle(chat_id, title)) as Promise<true>
    }

    /** Use this method to change the description of a group, a supergroup or a channel. The bot must be an administrator in the chat for this to work and must have the appropriate admin rights. Returns True on success. */
    setChatDescription(chat_id: number|string, optional?: { description?: string }): Promise<true> {
        return this.sendMethod(new TG.setChatDescription(chat_id, optional?.description)) as Promise<true>
    }

    /** Use this method to add a message to the list of pinned messages in a chat. If the chat is not a private chat, the bot must be an administrator in the chat for this to work and must have the &#39;can_pin_messages&#39; admin right in a supergroup or &#39;can_edit_messages&#39; admin right in a channel. Returns True on success. */
    pinChatMessage(chat_id: number|string, message_id: number, optional?: { disable_notification?: boolean }): Promise<true> {
        return this.sendMethod(new TG.pinChatMessage(chat_id, message_id, optional?.disable_notification)) as Promise<true>
    }

    /** Use this method to remove a message from the list of pinned messages in a chat. If the chat is not a private chat, the bot must be an administrator in the chat for this to work and must have the &#39;can_pin_messages&#39; admin right in a supergroup or &#39;can_edit_messages&#39; admin right in a channel. Returns True on success. */
    unpinChatMessage(chat_id: number|string, optional?: { message_id?: number }): Promise<true> {
        return this.sendMethod(new TG.unpinChatMessage(chat_id, optional?.message_id)) as Promise<true>
    }

    /** Use this method to clear the list of pinned messages in a chat. If the chat is not a private chat, the bot must be an administrator in the chat for this to work and must have the &#39;can_pin_messages&#39; admin right in a supergroup or &#39;can_edit_messages&#39; admin right in a channel. Returns True on success. */
    unpinAllChatMessages(chat_id: number|string): Promise<true> {
        return this.sendMethod(new TG.unpinAllChatMessages(chat_id)) as Promise<true>
    }

    /** Use this method for your bot to leave a group, supergroup or channel. Returns True on success. */
    leaveChat(chat_id: number|string): Promise<true> {
        return this.sendMethod(new TG.leaveChat(chat_id)) as Promise<true>
    }
    ...
    getChatMembersCount(chat_id: number|string): Promise<number> {
        return this.sendMethod(new TG.getChatMembersCount(chat_id)) as Promise<number>
    }
    ...
    setChatStickerSet(chat_id: number|string, sticker_set_name: string): Promise<true> {
        return this.sendMethod(new TG.setChatStickerSet(chat_id, sticker_set_name)) as Promise<true>
    }
    ...
    deleteChatStickerSet(chat_id: number|string): Promise<true> {
        return this.sendMethod(new TG.deleteChatStickerSet(chat_id)) as Promise<true>
    }
    ...
    answerCallbackQuery(callback_query_id: string, optional?: { text?: string, show_alert?: boolean, url?: string, cache_time?: number }): Promise<true> {
        return this.sendMethod(new TG.answerCallbackQuery(callback_query_id, optional?.text, optional?.show_alert, optional?.url, optional?.cache_time)) as Promise<true>
    }

    /** Use this method to change the list of the bot&#39;s commands. Returns True on success. */
    setMyCommands(commands: Array<TG.BotCommand>): Promise<true> {
        return this.sendMethod(new TG.setMyCommands(commands)) as Promise<true>
    }
    ...
    getMyCommands(): Promise<Array<TG.BotCommand>> {
        return this.sendMethod(new TG.getMyCommands()) as Promise<Array<TG.BotCommand>>
    }
    ...
    editMessageText(text: string, optional?: { chat_id?: number|string, message_id?: number, inline_message_id?: string, parse_mode?: string, entities?: Array<TG.MessageEntity>, disable_web_page_preview?: boolean, reply_markup?: TG.InlineKeyboardMarkup }): Promise<TG.Message | true> {
        return this.sendMethod(new TG.editMessageText(text, optional?.chat_id, optional?.message_id, optional?.inline_message_id, optional?.parse_mode, optional?.entities, optional?.disable_web_page_preview, optional?.reply_markup)) as Promise<TG.Message | true>
    }
    ...
    editMessageCaption(optional?: { chat_id?: number|string, message_id?: number, inline_message_id?: string, caption?: string, parse_mode?: string, caption_entities?: Array<TG.MessageEntity>, reply_markup?: TG.InlineKeyboardMarkup }): Promise<TG.Message | true> {
        return this.sendMethod(new TG.editMessageCaption(optional?.chat_id, optional?.message_id, optional?.inline_message_id, optional?.caption, optional?.parse_mode, optional?.caption_entities, optional?.reply_markup)) as Promise<TG.Message | true>
    }
    ...
    editMessageMedia(media: TG.InputMedia, optional?: { chat_id?: number|string, message_id?: number, inline_message_id?: string, reply_markup?: TG.InlineKeyboardMarkup }): Promise<TG.Message | true> {
        return this.sendMethod(new TG.editMessageMedia(media, optional?.chat_id, optional?.message_id, optional?.inline_message_id, optional?.reply_markup)) as Promise<TG.Message | true>
    }
    ...
    editMessageReplyMarkup(optional?: { chat_id?: number|string, message_id?: number, inline_message_id?: string, reply_markup?: TG.InlineKeyboardMarkup }): Promise<TG.Message | true> {
        return this.sendMethod(new TG.editMessageReplyMarkup(optional?.chat_id, optional?.message_id, optional?.inline_message_id, optional?.reply_markup)) as Promise<TG.Message | true>
    }
    ...
    deleteMessage(chat_id: number|string, message_id: number): Promise<true> {
        return this.sendMethod(new TG.deleteMessage(chat_id, message_id)) as Promise<true>
    }
    ...
    createNewStickerSet(user_id: number, name: string, title: string, emojis: string, optional?: { png_sticker?: TG.InputFile|string, tgs_sticker?: TG.InputFile, contains_masks?: boolean, mask_position?: TG.MaskPosition }): Promise<true> {
        return this.sendMethod(new TG.createNewStickerSet(user_id, name, title, emojis, optional?.png_sticker, optional?.tgs_sticker, optional?.contains_masks, optional?.mask_position)) as Promise<true>
    }

    /** Use this method to add a new sticker to a set created by the bot. You must use exactly one of the fields png_sticker or tgs_sticker. Animated stickers can be added to animated sticker sets and only to them. Animated sticker sets can have up to 50 stickers. Static sticker sets can have up to 120 stickers. Returns True on success. */
    addStickerToSet(user_id: number, name: string, emojis: string, optional?: { png_sticker?: TG.InputFile|string, tgs_sticker?: TG.InputFile, mask_position?: TG.MaskPosition }): Promise<true> {
        return this.sendMethod(new TG.addStickerToSet(user_id, name, emojis, optional?.png_sticker, optional?.tgs_sticker, optional?.mask_position)) as Promise<true>
    }

    /** Use this method to move a sticker in a set created by the bot to a specific position. Returns True on success. */
    setStickerPositionInSet(sticker: string, position: number): Promise<true> {
        return this.sendMethod(new TG.setStickerPositionInSet(sticker, position)) as Promise<true>
    }

    /** Use this method to delete a sticker from a set created by the bot. Returns True on success. */
    deleteStickerFromSet(sticker: string): Promise<true> {
        return this.sendMethod(new TG.deleteStickerFromSet(sticker)) as Promise<true>
    }

    /** Use this method to set the thumbnail of a sticker set. Animated thumbnails can be set for animated sticker sets only. Returns True on success. */
    setStickerSetThumb(name: string, user_id: number, optional?: { thumb?: TG.InputFile|string }): Promise<true> {
        return this.sendMethod(new TG.setStickerSetThumb(name, user_id, optional?.thumb)) as Promise<true>
    }

    /** Use this method to send answers to an inline query. On success, True is returned.No more than 50 results per query are allowed. */
    answerInlineQuery(inline_query_id: string, results: Array<TG.InlineQueryResult>, optional?: { cache_time?: number, is_personal?: boolean, next_offset?: string, switch_pm_text?: string, switch_pm_parameter?: string }): Promise<true> {
        return this.sendMethod(new TG.answerInlineQuery(inline_query_id, results, optional?.cache_time, optional?.is_personal, optional?.next_offset, optional?.switch_pm_text, optional?.switch_pm_parameter)) as Promise<true>
    }

    /** Use this method to send invoices. On success, the sent [Message](https://core.telegram.org/bots/api#message) is returned. */
    sendInvoice(chat_id: number, title: string, description: string, payload: string, provider_token: string, start_parameter: string, currency: string, prices: Array<TG.LabeledPrice>, optional?: { provider_data?: string, photo_url?: string, photo_size?: number, photo_width?: number, photo_height?: number, need_name?: boolean, need_phone_number?: boolean, need_email?: boolean, need_shipping_address?: boolean, send_phone_number_to_provider?: boolean, send_email_to_provider?: boolean, is_flexible?: boolean, disable_notification?: boolean, reply_to_message_id?: number, allow_sending_without_reply?: boolean, reply_markup?: TG.InlineKeyboardMarkup }): Promise<TG.Message> {
        return this.sendMethod(new TG.sendInvoice(chat_id, title, description, payload, provider_token, start_parameter, currency, prices, optional?.provider_data, optional?.photo_url, optional?.photo_size, optional?.photo_width, optional?.photo_height, optional?.need_name, optional?.need_phone_number, optional?.need_email, optional?.need_shipping_address, optional?.send_phone_number_to_provider, optional?.send_email_to_provider, optional?.is_flexible, optional?.disable_notification, optional?.reply_to_message_id, optional?.allow_sending_without_reply, optional?.reply_markup)) as Promise<TG.Message>
    }
    ...
    answerShippingQuery(shipping_query_id: string, ok: boolean, optional?: { shipping_options?: Array<TG.ShippingOption>, error_message?: string }): Promise<true> {
        return this.sendMethod(new TG.answerShippingQuery(shipping_query_id, ok, optional?.shipping_options, optional?.error_message)) as Promise<true>
    }

    /** Once the user has confirmed their payment and shipping details, the Bot API sends the final confirmation in the form of an [Update](https://core.telegram.org/bots/api#update) with the field pre_checkout_query. Use this method to respond to such pre-checkout queries. On success, True is returned. Note: The Bot API must receive an answer within 10 seconds after the pre-checkout query was sent. */
    answerPreCheckoutQuery(pre_checkout_query_id: string, ok: boolean, optional?: { error_message?: string }): Promise<true> {
        return this.sendMethod(new TG.answerPreCheckoutQuery(pre_checkout_query_id, ok, optional?.error_message)) as Promise<true>
    }

    /** Informs a user that some of the Telegram Passport elements they provided contains errors. The user will not be able to re-submit their Passport to you until the errors are fixed (the contents of the field for which you returned the error must change). Returns True on success. Use this if the data submitted by the user doesn&#39;t satisfy the standards your service requires for any reason. For example, if a birthday date seems invalid, a submitted document is blurry, a scan shows evidence of tampering, etc. Supply some details in the error message to make sure the user knows how to correct the issues. */
    setPassportDataErrors(user_id: number, errors: Array<TG.PassportElementError>): Promise<true> {
        return this.sendMethod(new TG.setPassportDataErrors(user_id, errors)) as Promise<true>
    }
